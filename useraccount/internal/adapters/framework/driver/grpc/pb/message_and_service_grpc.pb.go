...
type ExistCRUDClient interface {
	...
	RetreiveUserBasedOnField(ctx context.Context, in *RetreivePersonInfoParameters, opts ...grpc.CallOption) (*PersonInfoResponse, error)
...
func (c *existCRUDClient) RetreiveUserBasedOnField(ctx context.Context, in *RetreivePersonInfoParameters, opts ...grpc.CallOption) (*PersonInfoResponse, error) {
	out := new(PersonInfoResponse)
	err := c.cc.Invoke(ctx, "/pb.ExistCRUD/RetreiveUserBasedOnField", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExistCRUDServer interface {
	...
	RetreiveUserBasedOnField(context.Context, *RetreivePersonInfoParameters) (*PersonInfoResponse, error)
...
func (UnimplementedExistCRUDServer) RetreiveUserBasedOnField(context.Context, *RetreivePersonInfoParameters) (*PersonInfoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RetreiveUserBasedOnField not implemented")
}
...
func _ExistCRUD_RetreiveUserBasedOnField_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RetreivePersonInfoParameters)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExistCRUDServer).RetreiveUserBasedOnField(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.ExistCRUD/RetreiveUserBasedOnField",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExistCRUDServer).RetreiveUserBasedOnField(ctx, req.(*RetreivePersonInfoParameters))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ExistCRUD_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RetreiveUserBasedOnField",
			Handler:    _ExistCRUD_RetreiveUserBasedOnField_Handler,
		},
		{
