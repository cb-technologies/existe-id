...
func (c *existCRUDServiceClient) UpdatePersonInfo(ctx context.Context, in *EditPersonInfoParameters, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/pb.ExistCRUDService/UpdatePersonInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *existCRUDServiceClient) FindPersonInfo(ctx context.Context, in *NationalIDNumber, opts ...grpc.CallOption) (*PersonInfoResponse, error) {
...
func (UnimplementedExistCRUDServiceServer) UpdatePersonInfo(context.Context, *EditPersonInfoParameters) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdatePersonInfo not implemented")
}
func (UnimplementedExistCRUDServiceServer) FindPersonInfo(context.Context, *NationalIDNumber) (*PersonInfoResponse, error) {
...
func _ExistCRUDService_UpdatePersonInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EditPersonInfoParameters)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExistCRUDServiceServer).UpdatePersonInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.ExistCRUDService/UpdatePersonInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExistCRUDServiceServer).UpdatePersonInfo(ctx, req.(*EditPersonInfoParameters))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ExistCRUDService_FindPersonInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExistCRUDServiceServer).FindPersonInfo(ctx, req.(*NationalIDNumber))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ExistCRUDService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ExistCRUDService_UpdatePersonInfo_Handler,
		},
		{
